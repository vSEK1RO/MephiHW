...
void arr_merge_int(int * arr, int left, int right, int * cntAssign, int * cntCompar);
...
int main()
{
    ...
    sort_arr_merge_int(arr,0,arr_len_int(arr)-1,&cntAssign,&cntCompar);
    arr_print_int(arr);
    arr_del_int(arr);
    printf("%d %d\n",cntAssign,cntCompar);
}
